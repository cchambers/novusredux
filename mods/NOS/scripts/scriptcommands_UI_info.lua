...
function DoInfo(target)
    ...
    elseif(curTab == "Stats") then
    	local array = { "Health", "Mana", "Stamina", "Vitality", "Str", "Agi", "Int", "Con", "Wis", "Will", "Accuracy", "Evasion", "Attack", "Power", "Force", "Defense", "AttackSpeed", "CritChance", "CritChanceReduction"}
