...
quotes = {
    {Text = "Your souls are MINE!!!",Audio="event:/monsters/death/death_voice_your_souls"},
    {Text = "Your time is nigh...",Audio="event:/monsters/death/death_voice_your_time"},
    {Text = "I will consume you.",Audio="event:/monsters/death/death_voice_consume_you1"},
    {Text = "I... will... consume you...",Audio="event:/monsters/death/death_voice_consume_you2"},
    {Text = "I will destroy you...",Audio="event:/monsters/death/death_voice_screw_you1"},
    --{Text = "I will destroy you...",Audio="event:/monsters/death/death_voice_screw_you2"},
    {Text = "FRESH BLOOD!",Audio="event:/monsters/death/death_voice_fresh_blood"},
}
...
--                object:PlayEffectWithArgs("ScreenShakeEffect", 3.0,"Magnitude=5")
        ...
        DistributeBossRewards(numIndexedTable, {TemplateDefines.LootTable.DeathBossGear}, "Death")
    end)
