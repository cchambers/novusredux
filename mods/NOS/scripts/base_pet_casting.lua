...
AI.StateMachine.AllStates.CastFireball = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Fireball", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        ...
        FaceTarget()
        if
            ((not CanCast("Fireball", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > (GetSpellRange("Fireball", this) + AI.GetSetting("SpellRangeMod")))
         then
...
AI.StateMachine.AllStates.CastFrost = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Frost", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
            AI.StateMachine.ChangeState("Idle")
        ...
        FaceTarget()
        if
            ((not CanCast("Frost", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > (GetSpellRange("Frost", this) + AI.GetSetting("SpellRangeMod")))
         then
            AI.StateMachine.ChangeState("Chase")
            return
        end
...
AI.StateMachine.AllStates.CastRuin = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Ruin", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
            AI.StateMachine.ChangeState("Idle")
        ...
        FaceTarget()
        if
            ((not CanCast("Ruin", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > (GetSpellRange("Ruin", this) + AI.GetSetting("SpellRangeMod")))
         then
            --DebugMessage("Can't Cast Fireball in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastElectricbolt = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Electricbolt", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        FaceTarget()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
        ...
        if
            ((not CanCast("Electricbolt", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Electricbolt", this) + AI.GetSetting("SpellRangeMod"))
         then
...
AI.StateMachine.AllStates.CastPoison = {
    ...
    OnEnterState = function()
        ...
        FaceTarget()
        if
            ((not CanCast("Poison", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Poison", this) + AI.GetSetting("SpellRangeMod"))
         then
            -- DebugMessage("Can't Cast Fireball in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastVoidblast = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Voidblast", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        FaceTarget()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
        ...
        if
            ((not CanCast("Voidblast", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Voidblast", this) + AI.GetSetting("SpellRangeMod"))
         then
            --DebugMessage("Can't Cast Lightning in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastSouldrain = {
    ...
    OnEnterState = function()
        ...
        if
            ((not CanCast("Souldrain", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Souldrain", this) + AI.GetSetting("SpellRangeMod"))
         then
            --DebugMessage("Can't Cast Lightning in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastLightning = {
    ...
    OnEnterState = function()
        ...
        if
            ((not CanCast("Lightning", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Lightning", this) + AI.GetSetting("SpellRangeMod"))
         then
            --DebugMessage("Can't Cast Lightning in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastChainlightning = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Chainlightning", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        FaceTarget()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
        ...
        if
            ((not CanCast("Chainlightning", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) >
                    GetSpellRange("Chainlightning", this) + AI.GetSetting("SpellRangeMod"))
         then
            --DebugMessage("Can't Cast Lightning in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastBombardment = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Bombardment", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        FaceTarget()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
        ...
        if
            ((not CanCast("Bombardment", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Bombardment", this) + AI.GetSetting("SpellRangeMod"))
         then
            --DebugMessage("Can't Cast Lightning in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastTeleport = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Teleport", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        FaceTarget()
...
AI.StateMachine.AllStates.CastBlackhole = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Blackhole", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        FaceTarget()
        ...
        if
            ((not CanCast("Blackhole", AI.MainTarget)) or
                this:GetLoc():Distance(teleLoc) > GetSpellRange("Blackhole", this) + AI.GetSetting("SpellRangeMod"))
         then
            --DebugMessage("Can't Cast Teleport in OnEnterState")
            --DebugMessage(2)
            AI.StateMachine.ChangeState("Chase")
...
AI.StateMachine.AllStates.CastSpawnskeleton = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Spawnskeleton", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        ...
        if
            ((not CanCast("Spawnskeleton", healTarget)) or (healTarget == this) or
                (this:DistanceFrom(healTarget) > GetSpellRange("Spawnskeleton", this) + AI.GetSetting("SpellRangeMod")))
         then
            --DebugMessage("Can't Cast Lightning in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastResurrect = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Resurrect", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        --pick a nearby friendly target that's dead, including me.
...
AI.StateMachine.AllStates.CastCloak = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Cloak", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
...
AI.StateMachine.AllStates.CastAuraoffire = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Auraoffire", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        --pick a nearby target with the lowest health and cloak them, including me.
        --DFB TODO: Make them cloak whatever is attacking their target
...
AI.StateMachine.AllStates.CastHeal = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Heal", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        ...
        local HealthPercentToAllowHeal =
            AI.GetSetting("HealthPercentToAllowHeal") or ServerSettings.AI.Casting.HealthPercentToAllowHeal
        ...
        if
            ((not CanCast("Heal", healTarget)) or
                this:DistanceFrom(healTarget) > GetSpellRange("Heal", this) + AI.GetSetting("SpellRangeMod"))
         then
            --DebugMessage("Can't Cast Lightning in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastGreaterheal = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Greaterheal", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        --pick a nearby target with the lowest health and heal it, including me.
        ...
        if
            ((not CanCast("Heal", healTarget)) or
                this:DistanceFrom(healTarget) > GetSpellRange("Greaterheal", this) + AI.GetSetting("SpellRangeMod"))
         then
            --DebugMessage("Can't Cast Lightning in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastPillaroffire = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Pillaroffire", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
            AI.StateMachine.ChangeState("Idle")
        ...
        FaceTarget()
        if
            (not CanCast("Pillaroffire", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Pillaroffire", this) + AI.GetSetting("SpellRangeMod")
         then
            --DebugMessage("Can't Cast Fireball in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastMeteor = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Meteor", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
            AI.StateMachine.ChangeState("Idle")
        ...
        FaceTarget()
        if
            (not CanCast("Meteor", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Meteor", this) + AI.GetSetting("SpellRangeMod")
         then
            --DebugMessage("Can't Cast Fireball in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastGrimaura = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Grimaura", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
            AI.StateMachine.ChangeState("Idle")
        ...
        FaceTarget()
        if
            (not CanCast("Grimaura", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Grimaura", this) + AI.GetSetting("SpellRangeMod")
         then
            --DebugMessage("Can't Cast Fireball in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastIcerain = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Icerain", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
            AI.StateMachine.ChangeState("Idle")
        ...
        FaceTarget()
        if
            (not CanCast("Icerain", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Icerain", this) + AI.GetSetting("SpellRangeMod")
         then
            --DebugMessage("Can't Cast Fireball in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastSpikepath = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Spikepath", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
            AI.StateMachine.ChangeState("Idle")
        ...
        FaceTarget()
        if
            (not CanCast("Spikepath", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Spikepath", this) + AI.GetSetting("SpellRangeMod")
         then
            --DebugMessage("Can't Cast Fireball in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastFlamewave = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Flamewave", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
            AI.StateMachine.ChangeState("Idle")
        ...
        FaceTarget()
        if
            (not CanCast("Flamewave", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Flamewave", this) + AI.GetSetting("SpellRangeMod")
         then
            --DebugMessage("Can't Cast Fireball in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
...
AI.StateMachine.AllStates.CastIcelance = {
    GetPulseFrequencyMS = function()
        return GetSpellCastTime("Icelance", this) * 1000 + math.random(400)
    end,
    OnEnterState = function()
        if (not (AI.IsValidTarget(AI.MainTarget))) then
            AI.StateMachine.ChangeState("Idle")
        ...
        FaceTarget()
        if
            (not CanCast("Icelance", AI.MainTarget)) or
                this:DistanceFrom(AI.MainTarget) > GetSpellRange("Icelance", this) + AI.GetSetting("SpellRangeMod")
         then
            --DebugMessage("Can't Cast Fireball in OnEnterState")
            AI.StateMachine.ChangeState("Chase")
            return
