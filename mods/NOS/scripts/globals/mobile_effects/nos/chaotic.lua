MobileEffectLibrary.Chaotic = 
{
	...
	OnExitState = function(self,root)
		...
		ForeachMobileAndPet(self.ParentObj, function(mobile)
			if ( mobile:HasObjVar("IsChaotic") ) then
				mobile:DelObjVar("IsChaotic")
				-- clear status override
				SetStatusIconOverride(mobile, "")
			end
		end, true)
	end,
	...
	ApplyIcon = function(self,root)
		ForeachMobileAndPet(self.ParentObj, function(mobile)
			if not( mobile:HasObjVar("IsChaotic") ) then
				mobile:SetObjVar("IsChaotic", true)
				SetStatusIconOverride(mobile, "Order")
			end
		end, true)
	end,
