SpellData = {
	...
	AllSpells = {
		...
		Clumsy = {
			...
			SpellPrimedFX2Args = "Bone=L_Hand",
			SpellHitSFX = "event:/magic/void/magic_void_grim_aura",
			SpellTooltipString = "Decrease targets agility.",
			SpellFXArgs = "Bone=Ground",
			requireLineOfSight = true,
			Skill = "MagerySkill",
			BeneficialSpellType = false,
		...
		Feeblemind = {
			...
			SpellPrimedFX2Args = "Bone=L_Hand",
			SpellHitSFX = "event:/magic/void/magic_void_grim_aura",
			SpellTooltipString = "Decrease targets intelligence.",
			SpellFXArgs = "Bone=Ground",
			requireLineOfSight = true,
			Skill = "MagerySkill",
			BeneficialSpellType = false,
		...
		MagicTrap = {
			...
			SpellPrimedFX2Name = "MagicPrimeHandRedEffect",
			SpellPrimedFX2Args = "Bone=L_Hand",
			SpellTooltipString = "Apply a spell trap to a container.",
			requireLineOfSight = true,
			Skill = "MagerySkill",
			AttackSpellType = false,
			SpellEnabled = true,
		...
		MagicUntrap = {
			...
			SpellPrimedFX2Name = "MagicPrimeHandRedEffect",
			SpellPrimedFX2Args = "Bone=L_Hand",
			SpellTooltipString = "Remove a spell trap from a container.",
			requireLineOfSight = true,
			Skill = "MagerySkill",
			AttackSpellType = false,
			SpellEnabled = true,
		...
		Shade = {
			SpellDisplayName = "Shade",
			PowerWords = "In Vox Sanct",
			TargetMobileEffect = "Taunt",
			Icon = "regenfocus",
			Circle = 4,
			manaCost = 70,
			effectType = "InstantHitSpell",
			...
			SpellPrimeSFX = "event:/magic/water/magic_water_cast_water",
			SpellHitSFX = "event:/magic/misc/magic_water_restoration",
			SpellTooltipString = "Causes your target to taunt, drawing enemies.",
			SpellFXArgs = "Bone=Ground",
			requireLineOfSight = true,
			Skill = "MagerySkill",
			MinSkillRequired = 50,
		...
		MindBlast = {
			...
			SpellPotencySkill = "MagerySkill",
			SpellPrimeSFX = "event:/magic/air/magic_air_cast_air",
			SpellTooltipString = "Shock your opponent's mind.",
			requireLineOfSight = true,
			Skill = "MagerySkill",
			MinSkillRequired = 70,
			spellSkillLevel = 75,
		...
		Reveal = {
			...
			manaCost = 25,
			upkeepCost = 0,
			--DamageType = "Bashing",	If earthquake breaks we know.
			effectType = "InstantHitSpell",
			SpellPower = 8,
			critChance = 20,
			SpellRange = 15,
		...
		ChainLightning = {
			SpellDisplayName = "Chain Lightning",
			...
			critChance = 12,
			SpellRange = 12,
			TargetMobileEffect = "ChainLightning",
			TargetType = "targetMobile",
			TargetRequired = true,
			CanBeInterrupted = true,
			SpellType = "MagicAttackTypeSpell",
		...
		MassCurse = {
			SpellDisplayName = "Mass Curse",
			PowerWords = "Uus Vas Mani",
			MobileEffect = "MassCurse",
			Icon = "regenfocus",
			Circle = 7,
			manaCost = 80,
			effectType = "InstantHitSpell",
			...
			SpellPrimeSFX = "event:/magic/water/magic_water_cast_water",
			SpellHitSFX = "event:/magic/misc/magic_water_restoration",
			SpellTooltipString = "Curses targets in range.",
			SpellFXArgs = "Bone=Ground",
			requireLineOfSight = true,
			Skill = "MagerySkill",
			MinSkillRequired = 60,
		...
		SummonDaemon = {
			SpellDisplayName = "Summon Daemon",
			PowerWords = "Kal Vas Xen Corp",
			MobileEffect = "SummonDaemon",
			Icon = "Fire Demon",
			Circle = 8,
			manaCost = 125,
			effectType = "InstantHitSpell",
