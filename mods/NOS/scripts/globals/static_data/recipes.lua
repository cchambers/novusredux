	...
	WoodsmithSkill = {
		{
			...
			Subcategories = {
				{"Wood","Wood","Wood"},
				{"Veneers","Veneers","Blightwood"},
                {"Laminates","Laminates","VileBlightwood"},
            },
		},	
		{
			Name = "Weapons",
...
WoodsmithSkill = {
		...
		CherryBoards = {
			...
			CraftingTemplateFile = "resource_cherry_boards",
			Description = "Cherry Boards",
			ItemType = "ResourceClass",
			Category = "Resources",
		...
		PurpleheartBoards = {
			...
			CraftingTemplateFile = "resource_purpleheart_boards",
			Description = "Purpleheart Boards",
			ItemType = "ResourceClass",
			Category = "Resources",
			Subcategory = "Laminates",
			NeedRecipe = true,
		...
		WormwoodBoards = {
			...
			CraftingTemplateFile = "resource_wormwood_boards",
			Description = "Wormwood Boards",
			ItemType = "ResourceClass",
			Category = "Resources",
			Subcategory = "Laminates",
			NeedRecipe = true,
		...
		OakVeneer = {
			...
			CraftingTemplateFile = "resource_oak_veneer",
		...
		YewVeneer = {
			...
			CraftingTemplateFile = "resource_yew_veneer",
			Description = "Yew Veneer",
			ItemType = "ResourceClass",
			Category = "Resources",
			Subcategory = "Veneers",
			NeedRecipe = true,
		...
		Barrel = {
			...
			Resources = {
				...
				AshBoards = { AshBoards = 2 },
				BlightwoodBoards = { BlightwoodBoards = 2 },
				CherryBoards = { CherryBoards = 2 },
				OakVeneer = { OakVeneer = 2 },
				YewVeneer = { YewVeneer = 2 }
			},	
		}, 
		...
		TableWoodenLarge = {
			...
			Resources = {
				...
				OakVeneer = { OakVeneer = 10 },
				YewVeneer = { YewVeneer = 10 }
			},	
		},
		WineBarrel = {
			MinLevelToCraft = 95,
		...
		WoodenBowl = {
			...
			NeedRecipe = false,
			CanImprove = true,
			CraftingTemplateFile = "furniture_wooden_bowl",
			Category = "Furnishings",
			Subcategory = "DecorativeItems",
			Resources = {
				Boards = { Boards = 8 },
		...
		Gate = {
			...
			Resources = {
				Boards = { Boards = 4 },
				AshBoards = { AshBoards = 4 },
				BlightwoodBoards = { BlightwoodBoards = 4 },
				OakVeneer = { OakVeneer = 4 },
				YewVeneer = { YewVeneer = 4 } 
			},	
		},
		Chest = {
			MinLevelToCraft = 35,
