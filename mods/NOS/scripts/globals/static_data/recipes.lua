	...
	WoodsmithSkill = {
		...
		},	
		{
			...
			Subcategories = {
				...
				{"TablesChairs", "Tables & Chairs", "Chairs"},
...
WoodsmithSkill = {
		...
		ShortBow = {
			...
			ItemType = "WeaponClass",
			Description = "A Short Bow. This is an apprentice weapon.",
			CanImprove = true,
			Category = "Weapons",
			Subcategory = "Bows",
			NeedRecipe = false,
		...
		BookshelfWoodenEmpty = {
			MinLevelToCraft = 64,
			MaxLevelToGain = 89,
			DisplayName = "Wooden Bookshelf",
			ItemType = "FurnitureClass",
			NeedRecipe = false,
			CraftingTemplateFile = "furniture_bookshelf_wooden_empty",
			Description = "[$3135]",
			Category = "Furnishings",
			Subcategory = "DecorativeItems",
			Resources = {
		...
		TinkerBoard = {
			MinLevelToCraft = 75,
			MaxLevelToGain = 100,
			DisplayName = "Tinker Toolboard",
			Description = "Tools for tinkering.",
			ItemType = "FurnitureClass",
			NeedRecipe = false,
			CraftingTemplateFile = "tool_board",
			Category = "Furnishings",
			Subcategory = "CraftingStations",
			Resources = {
				Iron = 20,
...
TinkeringSkill = {
	DyeTub = {
		MinLevelToCraft = 20,
		MaxLevelToGain = 45,
		DisplayName = "Blank Dye Tub",
		CraftingTemplateFile = "dye_tub",
		Description = "A tub for dyes.",
		ItemType = "ResourceClass",
		Category = "Resources",
		Subcategory = "Dyes",
		NeedRecipe = false,
	...
	SewingKit = {
		...
		CraftingTemplateFile = "tool_sewing_kit",
		Description = "A sewing kit for tailors.",
		ItemType = "WeaponClass",
		Category = "Equipment",
		Subcategory = "Tools",
		NeedRecipe = false,
	...
	SawTool = {
		...
		CraftingTemplateFile = "tool_saw",
		Description = "A saw for carpenters.",
		ItemType = "WeaponClass",
		Category = "Equipment",
		Subcategory = "Tools",
		NeedRecipe = false,
	...
	Bottle1 = {
		...
		CraftingTemplateFile = "empty_bottle_1",
		Description = "A bottle for potions.",
		ItemType = "ResourceClass",
		Category = "Resources",
		Subcategory = "Bottles",
		NeedRecipe = false,
	...
	Bottle2 = {
		...
		CraftingTemplateFile = "empty_bottle_2",
		Description = "A bottle for potions.",
		ItemType = "ResourceClass",
		Category = "Resources",
		Subcategory = "Bottles",
	...
	Bottle3 = {
		...
		CraftingTemplateFile = "empty_bottle_3",
		Description = "A bottle for potions.",
		ItemType = "ResourceClass",
		Category = "Resources",
		Subcategory = "Bottles",
	...
	Bottle4 = {
		...
		CraftingTemplateFile = "empty_bottle_4",
		Description = "A bottle for potions.",
		ItemType = "ResourceClass",
		Category = "Resources",
		Subcategory = "Bottles",
	...
	-- 	MinLevelToCraft = 50,
	-- 	MaxLevelToGain = 65,
	-- 	DisplayName = "XXL Empty Bottle",
	-- 	CraftingTemplateFile = "empty_bottle_5",
	-- 	Description = "A bottle for potions.",
	-- 	ItemType = "ResourceClass",
	-- 	Category = "Resources",
	-- 	Subcategory = "Bottles",
	...
	WireSteel = {
		...
		Description = "A spool of steel wire.",
		ItemType = "ResourceClass",
		Category = "Resources",
		Subcategory = "Wire",
		NeedRecipe = false,
	...
	WireSpectral = {
		...
		Description = "A spool of spectral wire.",
		ItemType = "ResourceClass",
		Category = "Resources",
		Subcategory = "Wire",
		NeedRecipe = false,
	...
	PartsCopper = {
		MinLevelToCraft = 70,
		MaxLevelToGain = 85,
		DisplayName = "Copper Parts",
		CraftingTemplateFile = "resource_parts_copper",
		Description = "A bunch of mechanical bits.",
		ItemType = "ResourceClass",
		Category = "Resources",
		Subcategory = "Parts",
		NeedRecipe = false,
	...
	PartsSpectral = {
		MinLevelToCraft = 80,
		MaxLevelToGain = 95,
		DisplayName = "Spectral Parts",
		CraftingTemplateFile = "resource_parts_spectral",
		Description = "A bunch of mechanical bits.",
		ItemType = "ResourceClass",
		Category = "Resources",
		Subcategory = "Parts",
	...
	PetGolemCopper = {
		...
		CraftingTemplateFile = "clockwork_golem_box_copper",
		Description = "A mechanical pet! Just [don't] add water.",
		ItemType = "ResourceClass",
		Category = "Equipment",
		Subcategory = "Pets",
		NeedRecipe = false,
	...
	PetGolemSpectral = {
		MinLevelToCraft = 65,
		MaxLevelToGain = 85,
		DisplayName = "Spectral Golem",
		CraftingTemplateFile = "clockwork_golem_box_spectral",
		Description = "A mechanical pet! Just [don't] add water.",
		ItemType = "ResourceClass",
		Category = "Equipment",
		Subcategory = "Pets",
...
FabricationSkill = {
		...
		GildedSilkCloth = {
			...
			CraftingTemplateFile = "resource_gilded_silk_cloth",
			Description = "A fabric woven from fine silk that was spun with gold wire. Can be used to make silk clothing and armor.",
			ItemType = "ResourceClass",
			Category = "Resources",
			Subcategory = "Cloth",
			NeedRecipe = true,
		...
		AntiqueSilkCloth = {
			...
			Description = "A fabric woven from fine silk that was spun with copper wire. Can be used to make silk clothing and armor.",
			ItemType = "ResourceClass",
			Category = "Resources",
			Subcategory = "Cloth",
			NeedRecipe = true,
		...
		SpectralSilkCloth = {
			...
			Description = "A fabric woven from fine silk that was spun with spectral wire. Can be used to make silk clothing and armor.",
			ItemType = "ResourceClass",
			Category = "Resources",
			Subcategory = "Cloth",
			NeedRecipe = true,
...
InscriptionSkill = {
		...
		MagicTrap = {
			MinLevelToCraft = -25,
			MaxLevelToGain = 25,
			DisplayName = "Trap Scroll",
			NeedRecipe = false,
			Description = "A` Trap scroll. ",
			CraftingTemplateFile = "scroll_trap",
			Category = "Scrolls",
			Subcategory = "Circle 2",
			Resources = {
				Ginseng = 1,
		...
		MagicUntrap = {
			MinLevelToCraft = -25,
			MaxLevelToGain = 25,
			DisplayName = "Untrap Scroll",
			NeedRecipe = false,
			Description = "An Untrap scroll. ",
			CraftingTemplateFile = "scroll_untrap",
			Category = "Scrolls",
			Subcategory = "Circle 2",
			Resources = {
				Ginseng = 1,
		...
		MagicLock = {
			...
			NeedRecipe = false,
			Description = "A Lock scroll. ",
			CraftingTemplateFile = "scroll_magiclock",
			Category = "Scrolls",
			Subcategory = "Circle 3",
			Resources = {
				LemonGrass = 1,
		...
		MagicUnlock = {
			MinLevelToCraft = 3.5,
			MaxLevelToGain = 53.5,
			DisplayName = "Unlock Scroll",
			NeedRecipe = false,
			Description = "An Unlock scroll. ",
			CraftingTemplateFile = "scroll_unlock",
			Category = "Scrolls",
			Subcategory = "Circle 3",
			Resources = {
				LemonGrass = 1,
		...
		RuinScroll = {
			MinLevelToCraft = -25,
			MaxLevelToGain = 25,
			DisplayName = "Harm Scroll",
			NeedRecipe = false,
			Description = "A harm scroll. ",
			CraftingTemplateFile = "scroll_harm",
			Category = "Scrolls",
			Subcategory = "Circle 2",
			Resources = {
				LemonGrass = 2,
