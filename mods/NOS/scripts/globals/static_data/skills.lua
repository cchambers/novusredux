...
-- 			DisplayName = "Magery",
-- 			PrimaryStat = "Intelligence",
-- 			Description = "Magery determines your effectiveness with spells.",
-- 			SkillType = "CombatTypeSkill",
-- 			GainFactor = 0.4,
-- 		},
-- 		ChannelingSkill = {
...
-- 			PrimaryStat = "Strength",
-- 			Description = "The Parrying skill is checked during combat to determine whether an attack can be fully blocked.",
-- 			SkillType = "CombatTypeSkill",
-- 			GainFactor = 0.3,
-- 		},
-- 		MetalsmithSkill = {
