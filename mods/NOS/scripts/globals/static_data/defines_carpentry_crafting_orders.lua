	...
	{
		{
			...
			LootItems = 
			{
				...
				{ Weight = 10, Template = "recipe_bookshelfwooden", Unique = true},
				{ Weight = 10, Template = "recipe_tableround", Unique = true},
				{ Weight = 10, Template = "recipe_tableinn", Unique = true},
				{ Weight = 10, Template = "recipe_standingtorch", Unique = true},
				{ Weight = 10, Template = "recipe_walllantern", Unique = true},
				{ Weight = 10, Template = "recipe_hanginglantern", Unique = true},
			},
		},	
	},
		...
		--5 Torch
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Weight = 100, Template = "resource_boards", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},
		...
		--40 Torch
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Weight = 100, Template = "resource_boards_ash", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},
		...
		--20 ShortBow
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Weight = 100, Template = "furniture_table_library", Packed = true, Unique = true},
					},
				},
		...
		--20 WarBow
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Weight = 100, Template = "Gate", Unique = true, StackCountMin = 1, StackCountMax = 3 },
					},
				},
