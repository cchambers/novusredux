	...
	{
		{
			...
			LootItems = 
			{
				...
				{ Weight = 10, Template = "recipe_lockpick", Unique = true},
				{ Weight = 10, Template = "recipe_cobalt", Unique = true},
				{ Weight = 8, Template = "recipe_obsidian", Unique = true},
				{ Weight = 5, Template = "recipe_steel", Unique = true}
			},
		},	
	},
		...
		--5 IronGreataxe
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Chance = 100, Template = "resource_iron", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},	
		...
		--5 IronScaleHelm
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Chance = 100, Template = "resource_gold", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},
				...
				--Reward 2
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Weight = 100, Template = "tool_mining_pick_gold", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},	
		...
		--5 IronFullPlateHelm
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Chance = 100, Template = "resource_copper", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},
				...
				--Reward 2
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Weight = 100, Template = "tool_mining_pick_copper", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},	
		...
		--15 IronFullPlateHelm
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Chance = 100, Template = "resource_cobalt", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},
				...
				--Reward 2
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Weight = 100, Template = "tool_mining_pick_cobalt", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},	
		...
		--15 GoldFullPlateHelm
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Chance = 100, Template = "resource_obsidian", Unique = true, StackCountMin = 1, StackCountMax = 3},
					},
				},
		...
		--80 CobaltFullPlateHelm
		{
			...
			LootTables = 
			{
				--Reward 1
				{
	    			...
	    			LootItems = 
	    			{
	    				{ Chance = 100, Template = "tool_anvil_gold", Packed = true, Unique = true },
					},
				},	
