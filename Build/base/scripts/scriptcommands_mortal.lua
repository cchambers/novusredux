...
RegisterCommand{ Command="g", AccessLevel = AccessLevel.Mortal, Func=MortalCommandFuncs.GuildMessage, Desc="Sends a guild message" }
RegisterCommand{ Command="r", AccessLevel = AccessLevel.Mortal, Func=MortalCommandFuncs.ReplyTell, Desc="Reply to a direct message." }
...
RegisterCommand{ Command="allegiance", AccessLevel = AccessLevel.Mortal, Func=MortalCommandFuncs.AllegianceMenu, Desc="Open allegiance window" }
RegisterCommand{ Command="karma", AccessLevel = AccessLevel.Mortal, Func=MortalCommandFuncs.Karma, Desc="Give you details and options regarding Karma." }
RegisterCommand{ Command="group", AccessLevel = AccessLevel.Mortal, Func=MortalCommandFuncs.GroupMessage, Desc="Sends a group message", Aliases={"gr", "party", "p"} }
