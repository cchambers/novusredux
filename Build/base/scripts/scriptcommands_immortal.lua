...
RegisterCommand{ Command="who", AccessLevel = AccessLevel.Immortal, Func=ImmortalCommandFuncs.Who, Desc="Lists players on the server" }
RegisterCommand{ Command="clock", AccessLevel = AccessLevel.Immortal, Func=ImmortalCommandFuncs.Clock, Desc="Opens a window that shows the time" }
...
RegisterCommand{ Command="tell", AccessLevel = AccessLevel.Immortal, Func=MortalCommandFuncs.Tell, Usage="<name|id>", Desc="Send a private message to another player." }