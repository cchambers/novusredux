	...
	{
		{
			...
			LootItems = 
			{
				...
				{ Weight = 10, Template = "recipe_woodenstool", Unique = true},
				{ Weight = 10, Template = "recipe_fancychair", Unique = true},
				{ Weight = 10, Template = "recipe_fancybench", Unique = true},
				...
				{ Weight = 10, Template = "recipe_chest", Unique = true},
				...
				{ Weight = 10, Template = "recipe_woodenbookshelf", Unique = true},
				{ Weight = 10, Template = "recipe_fancydesk", Unique = true},
				...
				{ Weight = 10, Template = "recipe_stonefireplace", Unique = true},
