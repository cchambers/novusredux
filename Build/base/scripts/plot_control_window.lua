...
function Init(controllerObj, plotControllerObj, defaultTab)    
    ...
    tab = defaultTab or ((isHouse and "Co-Owners") or "Taxes")
    UpdateWindow()
end
...
function TaxTab(dynamicWindow)
    ...
    dynamicWindow:AddButton(10,248,"Pay","Add to Tax Balance",311,26,"Deposit money into the tax balance for this plot.","",false,"List")
end
