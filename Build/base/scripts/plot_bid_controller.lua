...
RegisterEventHandler(EventType.Timer, "AuctionStart", function()
    this:ScheduleTimerDelay(TimeSpan.FromSeconds(_EndTime - GetNow()), "AuctionEnd")
...
if ( HasEnded(_TimeOfInit) ) then
    ...
    if ( IsActive(_TimeOfInit) ) then
        this:ScheduleTimerDelay(TimeSpan.FromSeconds(_EndTime - _TimeOfInit), "AuctionEnd")
    elseif not( HasStarted(_TimeOfInit) ) then
        this:ScheduleTimerDelay(TimeSpan.FromSeconds(_StartTime - _TimeOfInit), "AuctionStart")
    end
end
