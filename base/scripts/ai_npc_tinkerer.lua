...
{ --note that this is a single string on multiple lines
	"Good day, sir! I am the tinkerer of this town. Why don't you take a look on my goods?"
    .."\n\nI can also teach you the art of mining if you are interested.",
} 
...
AI.WellTrainedMessage = {
	"Seems like you already know enough about mining. There is nothing I can teach you more.",
}

AI.CannotAffordMessages = AI.CantAffordPurchaseMessages

AI.TrainScopeMessages = {
	"Absolutely! What do you wish to learn from me?",
}
...
AI.WhoMessages = {
	"I am "..StripColorFromString(this:GetSharedObjectProperty("DisplayName"))..". You won't find a good tinkerer other than me nearby, so I am the person to look for if you need a tinkerer.",
}
...
AI.HowMessages = {
	"I was attracted by the art of tinkering so I practiced it for my entire life. Would that be an answer to your question?",
}

AI.FamilyMessage = AI.HowMessages

AI.SpareTimeMessages= {
	"Practice tinkering is what I do in my spare time. Isn't that a wonderful way to spend time?",
}
...
function Dialog.OpenWhoDialog(user)
    ...
    response[2] = {}
    response[2].text = "How did you become a tinkerer?"
...
function Dialog.OpenFamilyDialog(user)
    DialogReturnMessage(this,user,"I do but it has been long since I last visited them. Making a living gives no time for that.","Oh..")
end
...
function Dialog.OpenLastNameDialog(user)
    DialogReturnMessage(this,user,"My last name? It's Morris. Nothing special.","Oh.")
end
